...
//		Order o1 = new Order("11", "地址1", new  ArrayList<Flower>());
//		Order o2 = new Order("22", "地址2", new  ArrayList<Flower>());
//		Order o3 = new Order("33", "地址3", new  ArrayList<Flower>());
...
//		}
//		System.out.println("********************");
//		Order o4 = new Order("11", "地址4", new  ArrayList<Flower>());
//		aa.add(o4);
