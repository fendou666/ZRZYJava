...
public class A5LinkedHashSet {
	private LinkedHashSet<BasicClass1> bc1 		= new LinkedHashSet<BasicClass1>();
	private LinkedHashSet<BasicClassEquals> bce = new LinkedHashSet<BasicClassEquals>();
	private LinkedHashSet<BasicClassHash> bch	= new LinkedHashSet<BasicClassHash>();
	private LinkedHashSet<BasicClassEqualsHash> bceh = new LinkedHashSet<BasicClassEqualsHash>();
	private LinkedHashSet<BasicClassCMP> bccmp	= new LinkedHashSet<BasicClassCMP>();
	
	public void showData(LinkedHashSet t){
	 ...
	 * 并未实现
	 */
//	public <T> void addData(LinkedHashSet<T> t){
...
//		bc1.c  没有调出来compare方法，所有需要重写compare方法来排序
	...
	public static void main(String[] args) {
		A5LinkedHashSet stuData = new A5LinkedHashSet();
		stuData.dataInit();
//		默认排序测试
